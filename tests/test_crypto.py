...
from aioquic.crypto import derive_keying_material, encrypt_packet
...
class CryptoTest(TestCase):
    ...
    def test_encrypt_packet_client(self):
        ...
        plain_header = binascii.unhexlify('c3ff000012508394c8f03e51570800449f00000002')
        plain_payload = binascii.unhexlify(
        ...
        packet = encrypt_packet(key, iv, hp, plain_header, plain_payload)

        self.assertEqual(packet, binascii.unhexlify(
    ...
    def test_encrypt_packet_server(self):
        ...
        plain_header = binascii.unhexlify('c1ff00001205f067a5502a4262b50040740001')
        plain_payload = binascii.unhexlify(
